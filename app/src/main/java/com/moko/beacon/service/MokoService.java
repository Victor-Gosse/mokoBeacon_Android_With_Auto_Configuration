...
public class MokoService extends Service implements MokoConnStateCallback, MokoOrderTaskCallback {
    ...
    public void onCreate() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            LogModule.i("Démarrer le service en arrière-plan");
        }
    ...
    public void onDestroy() {
        LogModule.i("Désactiver les services d'arrière-plan");
     ...
     * @Author wenzheng.liu
     * @Description Obtenez des informations lisibles
     */
    ...
    public void onOrderFinish() {
        LogModule.i("Achèvement de la tâche");
